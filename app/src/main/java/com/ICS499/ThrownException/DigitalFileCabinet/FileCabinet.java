...
public class FileCabinet extends Application {
    ...
    public EditAccount getEditAccount(){return editAccount;}
    public void setEditAccount(EditAccount editAccount){this.editAccount = editAccount;}
    ...
    public void setFileBrowser(FileBrowser fileBrowser){this.fileBrowser = fileBrowser;}
}
